...
public class PlaceNameService implements Runnable {
    ...
    public final String CSV_PATH = getResourcePath("places.csv");
    ...
    public static void main( String[] args ) throws IOException{
        ...
        svc.start(DEFAULT_SERVICE_PORT);
        Routes.configureRoutes(svc.server, svc.places);
    }
    ...
    public String getResourcePath(String resourceName) {
        ...
        if (classLoader != null) {
            ...
            if (resourceUrl != null) {
                ...
                return "src/main/resources/places.csv";
            }
        } else {
            System.err.println("Class Loader is not available.");
            return null;
        }
    }
